...
function TCustomer.Index: String;
begin
  //use Context property to access to the HTTP request and response 
  Result := 'Hello DelphiMVCFramework World';
end;

function TCustomer.GetReversedString(const Value: String): String;
begin
...
//Sample CRUD Actions for a "People" entity
function TCustomer.GetPeople: TObjectList<TPerson>;
var
...
function TCustomer.GetPerson(ID: Integer): TPerson;
var
  lPeople: TObjectList<TPerson>;
begin
  lPeople := GetPeople;
...
function TCustomer.CreatePerson([MVCFromBody] Person: TPerson): IMVCResponse;
begin
...
function TCustomer.UpdatePerson(ID: Integer; [MVCFromBody] Person: TPerson): IMVCResponse;
begin
...
function TCustomer.DeletePerson(ID: Integer): IMVCResponse;
begin
